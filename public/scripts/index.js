  ...
  filteredCarsData.map((filteredCar) => {
    filteredCardWithCars += `<div class="col-lg-6 col-xl-4 mb-4">
        <div class="card shadow-sm p-3 bg-white h-100">
          ...
          <span><img src="images/icon_people.svg" style="height: 22px;">&ensp;${filteredCar.capacity} orang</span>
          <span class="mt-2"><img src="images/icon_gear.svg"
...
filterButton.addEventListener("click", (event) => {
  ...
  console.log(desiredCapacity, desiredDate, desiredTime);
